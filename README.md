<img src="misc_files/website_image_header.png" alt="Header" width="100%">

# Global Zooplankton Trait Database version 1 (GZTDv1)
The global zooplankton trait database was developed by Pata and Hunt (2023). This repository also contains scripts for generating figures summarizing and analyzing the contents of the database, and a template for subsetting trait information from the database and estimating missing trait values.
