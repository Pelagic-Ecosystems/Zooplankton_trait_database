...
ggsave(filename="figures/fig_7_allometric_scaling.tiff",
    width=24.75, height=29, units = "cm",  dpi = 600, 
...
*NOTE* By default this chunk does not run because it may take a long time for it to finish computing. If you wish to explore using this chunk, you need to download the `Rphylopars` package and load it (which is currently commented out in line 26).
...
ggsave("figures/fig_8_comparison_estimation_percent_removed.tiff",
       width = 21, height = 22, units = "cm", dpi = 600, bg = "white",
    device = "tiff", compression = "lzw")
```
...
ggsave("figures/supp_fig_3_comparison_estimation_nspecies_removed.tiff",
       width = 21, height = 22, units = "cm", dpi = 600, bg = "white",
    device = "tiff", compression = "lzw")
```
